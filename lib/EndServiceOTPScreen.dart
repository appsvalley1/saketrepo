...
class EndServiceOTPScreen extends StatefulWidget {
  String orderID = "0";

  EndServiceOTPScreen(this.orderID);

  @override
  State createState() => new EndServiceOTPState(orderID);
}

class EndServiceOTPState extends State<EndServiceOTPScreen>
    with SingleTickerProviderStateMixin {
  final _formKey = GlobalKey<FormState>();
  String orderID = "0";

  EndServiceOTPState(this.orderID);
  ...
  Future<LoginResp> verifyEndOTP() async {
    String url = "http://api.rentcity.in/Service1.svc/VerifyEndOTP?OTP=" +
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
        ...
        appBar: AppBar(
          ...
          title: new Text("Enter Service Complete OTP"),
          actions: <Widget>[],
        ),
