...
class ServiceManActiveOrders extends StatefulWidget {
  @override
  State createState() => new ServiceManActiveOrdersState();
}

class ServiceManActiveOrdersState extends State<ServiceManActiveOrders>
  ...
  Future<List<ListOrders>> getMyOrders() async {
    var response = await http.get(Uri.encodeFull(
        "http://api.rentcity.in/Service1.svc/GetActiveAssignedOrdersBy?OrderAssignedTo=" +
            userid));
    print(
        "http://api.rentcity.in/Service1.svc/GetActiveAssignedOrdersBy?OrderAssignedTo=" +
            userid);
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text("Looks like No Active orders are there",
                                style: TextStyle(
                                    fontSize: 14,
                                    fontWeight: FontWeight.bold,
                                          ...
                                          child: Center(
                                            child: Column(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Text(
                                                    "Looks like No Active orders are there",
                                                    style: TextStyle(
                                                        fontSize: 14,
                                                        fontWeight:
                                                            FontWeight.bold,
