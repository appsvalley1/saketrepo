...
class UpdateKYCPage extends StatefulWidget {
  ...
  @override
  State createState() => new UpdateKYCPageState();
}

class UpdateKYCPageState extends State<UpdateKYCPage>
...
//print(response.body);
 ...
 if(panAnimationController!=null)
  ...
  Future getCameraAdhar(BuildContext context) async {
    var image = await ImagePicker.pickImage(source: ImageSource.gallery);
  ...
  Future getCameraPan(BuildContext context) async {
    var image = await ImagePicker.pickImage(source: ImageSource.gallery);
  ...
  showAlertDialog(BuildContext context, bool isAdhar) {
    ...
    Widget launchButton = FlatButton(
      ...
      onPressed: () {
        if (isAdhar) {
          getCameraAdhar(context);
        } else {
          getCameraPan(context);
        }
